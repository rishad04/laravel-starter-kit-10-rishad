                    ...
                    <form action="{{route('language.store')}}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" name="native" id="native" class="form-control input-style-1" value="{{ old('native') }}" placeholder="{{ ___('language.enter_native') }}">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" placeholder="{{ ___('language.enter_regional') }}" class="form-control input-style-1" name="regional" value="{{ old('regional') }}">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <textarea name="script" id="script" class="form-control input-style-1" placeholder="{{ ___('language.enter_script') }}">{{ old('script') }}</textarea>
