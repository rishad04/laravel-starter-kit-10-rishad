                    ...
                    <form action="{{route('user.update',$user->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" placeholder="{{ __('placeholder.enter_designation') }} " class="form-control input-style-1" name="designations" value="{{ old('designations',$user->designations) }}">
                                @error('designations')
