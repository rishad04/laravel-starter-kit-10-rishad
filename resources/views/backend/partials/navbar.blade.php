            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="j-header-container">
                    <div class="j-header-content">
                        <div class="j-search">
                            <form class="j-search-form" action=" ">
                                <input class="j-form-control" type="text" placeholder="Search" name="q" id="search" list="route_list" data-url=" ">
                        ...
                        <div class="dropdown header-profile">
                            <a class="nav-np" href="#" role="button" data-toggle="dropdown">
                                <img src="{{auth()->user()->image}}" class="np" alt="" />
