...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['middleware' => 'XSS'], function () {
        Route::group(['prefix' => 'admin/settings'], function () {
            ...
            Route::put('general-settings',              [SettingsController::class, 'updateGeneralSettings'])->name('settings.general.update')->middleware('hasPermission:general_settings_update');
            ...
            Route::put('recaptcha',                     [SettingsController::class, 'updateRecaptcha'])->name('settings.recaptcha.update')->middleware('hasPermission:recaptcha_settings_update');
