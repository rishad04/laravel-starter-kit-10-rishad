...
class SettingSeeder extends Seeder
{
    ...
    private function settings(): array
    {
        return [
            ...
            ['key' => 'logo_with_text',         'value' => DB::table('uploads')->insertGetId(['original' => 'backend/assets/img/logo/logo_with_text.png'])],
            ['key' => 'logo',                   'value' => DB::table('uploads')->insertGetId(['original' => 'backend/assets/img/logo/logo.png'])],
            ['key' => 'favicon',                'value' => DB::table('uploads')->insertGetId(['original' => 'backend/assets/img/logo/favicon.png'])],
