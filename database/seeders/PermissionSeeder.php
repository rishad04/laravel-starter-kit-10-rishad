...
class PermissionSeeder extends Seeder
{
    ...
    private function permissions(): array
    {
        return [
            ...
            'dashboard'         => ['read' => 'dashboard_read', 'total_user' => 'total_user',],
            ...
            'language'          => ['read' =>  'language_read', 'create' => 'language_create', 'update' =>  'language_update', 'phrase' =>  'language_phrase', 'delete' =>  'language_delete'],
